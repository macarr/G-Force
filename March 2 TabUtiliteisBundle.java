...
public class TabUtilitiesBundle{
  PdfContentByte cB;
	...
	public void processHeader(ArrayList<String> header, float position){
		setFontSize(20f);
		
		cB.beginText();
		cB.showTextAlignedKerned(PdfContentByte.ALIGN_CENTER, header.get(0), 310, position, 0);	
		cB.setFontAndSize(bF, 10f);
		cB.showTextAlignedKerned(PdfContentByte.ALIGN_CENTER, header.get(1), 315, position - 15, 0);
		cB.endText();
